...
Organ.prototype = {
  ...
  resetDiv: function() {
    ...
    var computedStyle = getComputedStyle( this.sourceDiv );
    var sourceStyles = {
...
Brain.prototype = {
  ...
  init: function() {
    ...
    window.addEventListener( 'load', this.resetOrgans.bind( this ) );
    window.addEventListener( 'resize', this.resetOrgans.bind( this ) );
  ...
  resetOrgans: function() {

    this.organs.forEach( function( organ ) {
